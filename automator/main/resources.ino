...
const PROGMEM uint8_t timertable[24][12] = {
  ...
  /* 06 */  { MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEON,  MODEON,  MODEON,  MODEON,  MODEON,  MODEON  },
  ...
  /* 21 */  { MODEON,  MODEON,  MODEON,  MODEON,  MODEON,  MODEON,  MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF },
