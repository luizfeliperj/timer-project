// Timer table MODEOFF(off) MODEON(on)
const PROGMEM byte timertable[24][12] = {
  ...
  /* 06 */  { MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF, MODEOFF },
  /* 07 */  { MODEOFF, MODEOFF, MODEOFF, MODEON,  MODEON,  MODEON,  MODEON,  MODEON,  MODEON,  MODEON,  MODEON,  MODEON  },
